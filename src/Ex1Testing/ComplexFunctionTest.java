...
class ComplexFunctionTest {
    ...
    @Test
    void testDivid() {
        String str = "Div(-1.0x^4+2.4x^2+3.1, 0.1x^5-1.2999999999999998x^1+5.0)";
        String s1 = "3.1 +2.4x^2 -x^4";
        String s2 = "5 +2x -3.3x +0.1x^5";
        Polynom p1 = new Polynom(s1);
        Polynom p2 = new Polynom(s2);
        ComplexFunction cf = new ComplexFunction("Divid", p1, p2);
    ...
    void testF() {
        ...
        cf.mul(p3);
        double x = cf.f(34);
        assertEquals(-1020.236839714342, x);
    }
    @Test
    void TestInitfromstring(){
        ...
        Polynom p3 = new Polynom(s3);
        cf3.mul(p3);
        String Str=cf3.toString();
        function cf2 = cf3.initFromString(Str);
